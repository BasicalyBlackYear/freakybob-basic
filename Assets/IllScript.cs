...
public class IllScript : MonoBehaviour
{
    ...
    private void TargetPlayer()
    {
        ...
        if (!this.playerSpotted)
        {
            ...
            this.audioDevice.PlayOneShot(this.aud_PunchYou);
        }
    }
    ...
    public void Disappoint()
    {
        ...
        this.audioDevice.PlayOneShot(this.aud_Angry);
    }

    public void Happy() 
    {
        this.audioDevice.PlayOneShot(this.aud_Hehe);
    }
    ...
    public AudioClip[] aud_Random = new AudioClip[5];
    ...
    public AudioClip aud_PunchYou;

    // Token: 0x04000088 RID: 136
    public AudioClip aud_Hehe;

    // Token: 0x0400008A RID: 138
    public AudioClip aud_Angry;
